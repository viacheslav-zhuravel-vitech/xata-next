...
export const Hero = () => {
  return (
    <div className="relative flex flex-col justify-between items-center mt-2 bg-green-50 md:flex-row">
      ...
      <div className="flex-2 flex h-full w-full">
        <Image src={hero} alt="your-hero-house" className="object-cover" />
      </div>
    </div>
  );
};
